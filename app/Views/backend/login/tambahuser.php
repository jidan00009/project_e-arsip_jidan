<div id="layoutSidenav_content">
    <main>
        ...
        <h1 class="mt-4">Tambah Pengguna</h1>
            ...
            <?php endif; ?>
            <!-- <label for="kategori">Tambah Pengguna</label> -->
            <form class="tambahakses" action="/admin/simpanuser" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="akses" name="akses" required>
                            ...
                            <?php foreach ($akses as $akses_item): ?>
                                <option value="<?php echo $akses_item; ?>"><?php echo $akses_item; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="btn-group">
                        ...
                        <a href="<?= site_url('admin/profile'); ?>" class="btn btn-secondary">Batal</a>
                    </div>
                </div>
            </form>
